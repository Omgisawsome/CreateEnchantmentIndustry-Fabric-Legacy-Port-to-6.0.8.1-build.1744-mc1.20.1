...
public class EnchantingGuideItem extends Item implements MenuProvider, ExtendedScreenHandlerFactory {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
		...
		if (!player.isShiftKeyDown() && hand == InteractionHand.MAIN_HAND) {
			if (!world.isClientSide && player instanceof ServerPlayer) {
				// FABRIC: Use openMenu instead of NetworkHooks
	...
	// FABRIC: This writes the data that EnchantingGuideMenu needs when it opens
	@Override
	public void writeScreenOpeningData(ServerPlayer player, FriendlyByteBuf buf) {
		buf.writeItem(player.getMainHandItem());
		buf.writeBoolean(true); // isItem (not block entity)
	}
